...
namespace gfX
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<GFXUserService>();
        ...
        {
            services.AddMvc();
            services.Configure<AppSettings>(Configuration.GetSection("TestConnection"));
            services.AddAuthentication(options =>
            {
                options.DefaultAuthenticateScheme = CookieAuthenticationDefaults.AuthenticationScheme;
                options.DefaultSignInScheme = CookieAuthenticationDefaults.AuthenticationScheme;
                ...
                .AddOAuth("GitHub", options =>
                {
                    options.ClientId = Configuration["GitHub2:ClientId"];
                    options.ClientSecret = Configuration["GitHub2:ClientSecret"];
                    options.CallbackPath = new PathString("/signin-github");
                    options.Scope.Add("read:org");
